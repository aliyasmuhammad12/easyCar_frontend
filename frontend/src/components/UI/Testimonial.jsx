  ...
  return (
    <Slider {...settings}>
      <div className="testimonial py-4 px-3">
        ...
        Great rental experience: courteous manager, transparent contract, and an excellent Rapid car in immaculate condition—clean interior, no scuffs or scratches. Delighted with my choice, highly recommend to al
        </p>
        <div className="mt-3 d-flex align-items-center gap-4">
          <img src={ava01} alt="ava" className="w-25 h-25 rounded" />
          <div>
            <h6 className="mb-0 mt-3">Andrey Ivanov</h6>
            <p className="tex-light">Customer</p>
          </div>
        </div>
      </div>
      <div className="testimonial py-4 px-3">
